...
<pre id="plutouiterminal">MethodInstance for Main.var\"workspace#4\".double(::Dict{Symbol, AbstractFloat}, ::Symbol)
  from double(�[90mmapping�[39m, �[90mkey�[39m::�[1mSymbol�[22m)�[90m @�[39m �[90mMain.var\"workspace#4\"�[39m �[90m~/work/curso_datos_julia/curso_datos_julia/tutorials/�[39m�[90m�[4mbenchmarking.jl#==#3f0e2049-8597-4dac-b499-4d7a8a35978e:1�[24m�[39m
Arguments
...
<pre id="plutouiterminal">BenchmarkTools.Trial: 10000 samples with 991 evaluations.
 Range (min … max):  42.248 ns … 566.394 ns  ┊ GC (min … max): 0.00% … 87.72%
 Time  (median):     44.018 ns               ┊ GC (median):    0.00%
 Time  (mean ± σ):   45.420 ns ±  11.429 ns  ┊ GC (mean ± σ):  0.32% ±  1.50%

   ▁▁▃█▃▁                                                      ▁
  ▃██████▇▆▆▆▆▅▅▅▅▅▇▇▆▆▅▄▅▅▅▆▆▆▆▆▆▅▆▆▆▆▆▅▅▆▅▆▅▅▆▆▆▆▆▅▅▅▆▅▄▅▄▄▄ █
  42.2 ns       Histogram: log(frequency) by time      65.8 ns &lt;
...
<pre id="plutouiterminal">BenchmarkTools.Trial: 10000 samples with 997 evaluations.
 Range (min … max):  20.780 ns … 548.061 ns  ┊ GC (min … max): 0.00% … 90.76%
 Time  (median):     22.711 ns               ┊ GC (median):    0.00%
 Time  (mean ± σ):   22.978 ns ±   9.458 ns  ┊ GC (mean ± σ):  0.62% ±  1.56%

  ▅▂ ▄▄▂█▄                                                     ▁
  ██▇███████▅▄▅▆▅▆▅▄▅▅▅▁▄▄▁▃▃▄▄▅▄▄▄▃▃▃▄▃▄▃▅▅▄▅▄▁▅▄▃▅▃▃▄▄▃▄▄▄▄▅ █
  20.8 ns       Histogram: log(frequency) by time      38.7 ns &lt;
